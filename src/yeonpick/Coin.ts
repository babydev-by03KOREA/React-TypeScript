import coinOne from '../assets/images/store/coinOne.png';
import coinTwo from '../assets/images/store/coinTwo.png';
import check from '../assets/images/store/check.png';
...
export const carousel02 = plantCoin;
